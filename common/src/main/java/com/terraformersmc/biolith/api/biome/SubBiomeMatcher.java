 ...
 * <ul>
 * <li/> NEAR_BORDER - Tries to target a fairly thin band around the edge of the target biome
 * <li/> NEAR_INTERIOR - Targets noise values near the center of the biome's noise range
 * </ul>
 */
...
public abstract class SubBiomeMatcher {
     ...
     * <li/> ALTERNATE - Compare to biome selected for given alternate original biome (BIOME only)
     ...
     * <ul>
     * <li/>BIOME - Compare to a specified biome (or biome tag) registry key
     * <li/>DISTANCE - Compare to noise distance from center of original biome noise point
     * <li/>RATIO - Compare to range of valid values for the original or target biome
     * <li/>VALUE - Compare to raw noise values for original biome noise point
     * </ul>
     */
