...
public class ModernerBetaBiomeKeys {
    ...
    public static final ResourceKey<Biome> BETA_OAK_FOREST = keyOf("beta_oak_forest");
    ...
    public static final ResourceKey<Biome> BETA_OAK_TAIGA = keyOf("beta_oak_taiga");
    ...
    public static final ResourceKey<Biome> INFDEV_325 = keyOf("infdev_325");
    ...
    public static final ResourceKey<Biome> CLASSIC_14A_08 = keyOf("classic_14a_08");

    public static final ResourceKey<Biome> LATE_BETA_EXTREME_HILLS = keyOf("late_beta_extreme_hills");
    public static final ResourceKey<Biome> LATE_BETA_ICE_PLAINS = keyOf("late_beta_ice_plains");
    public static final ResourceKey<Biome> LATE_BETA_SWAMPLAND = keyOf("late_beta_swampland");
    public static final ResourceKey<Biome> LATE_BETA_PLAINS = keyOf("late_beta_plains");
    public static final ResourceKey<Biome> LATE_BETA_TAIGA = keyOf("late_beta_taiga");

    public static final ResourceKey<Biome> EARLY_RELEASE_ICE_PLAINS = keyOf("early_release_ice_plains");
    public static final ResourceKey<Biome> EARLY_RELEASE_SWAMPLAND = keyOf("early_release_swampland");
    public static final ResourceKey<Biome> EARLY_RELEASE_EXTREME_HILLS = keyOf("early_release_extreme_hills");
    public static final ResourceKey<Biome> EARLY_RELEASE_TAIGA = keyOf("early_release_taiga");
